...
import com.comp.model.agent.Agent;
import com.comp.model.agent.AgentFilters;
import com.comp.model.agent.AgentRepository;
...
public class MongoService {
    ...
    public List<Agent> getAgents(DataFetchingEnvironment environment){
        AgentFilters tf = mapper.convertValue(environment.getArgument("agentFilters"), AgentFilters.class);
        PaginationFilters pf = mapper.convertValue(environment.getArgument("pagination"), PaginationFilters.class);
        return tr.getAgents(tf,pf);
    }
