# ARCHIVED: Development of graphQL API is now integrated into [OpenEBench Scientific API](https://gitlab.bsc.es/inb/iechor/openebench/openebench-rest-api) development
